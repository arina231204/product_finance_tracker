    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', 'Новый'), ('2', 'Выслано предложение'), ('3', 'Переговоры'), ('4', 'Сделка заключена'), ('5', 'Сделка не заключена')], max_length=20, verbose_name='Статус')),
                ...
                ('contractor_type', models.CharField(blank=True, choices=[('1', 'Юридическое лицо'), ('2', 'Индивидуальный предприниматель'), ('3', 'Физическое лицо')], max_length=100, verbose_name='Тип контрагента')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accountingFeatures', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.accountingfeatures', verbose_name='Особенности учета')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.department', verbose_name='Отдел')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.product', verbose_name='Позиция')),
        ...
        migrations.AddField(
            model_name='product',
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.unitofmeasurement', verbose_name='Единица измерения'),
        ),
        migrations.AddField(
            model_name='product',
            name='vat',
